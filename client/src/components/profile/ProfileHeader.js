            ...
            <div className="text-center">
              ...
              <p>
                ...
                {!isEmpty(profile.social && profile.social.twitter) && (
                  <a
                    className="text-white p-2"
                    href={profile.social && profile.social.twitter}
                    target="_blank">
                ...
                {!isEmpty(profile.social && profile.social.facebook) && (
                  <a
                    className="text-white p-2"
                    href={profile.social && profile.social.facebook}
                    target="_blank">
                ...
                {!isEmpty(profile.social && profile.social.linkedin) && (
                  <a
                    className="text-white p-2"
                    href={profile.social && profile.social.linkedin}
                    target="_blank">
                ...
                {!isEmpty(profile.social && profile.social.instagram) && (
                  <a
                    className="text-white p-2"
                    href={profile.social && profile.social.instagram}
                    target="_blank">
